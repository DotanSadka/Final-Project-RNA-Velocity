...
def main():
    ...
    for r in T:
        ...
        df.to_csv(f"t={t}.csv", index= False)  # csv file to check sum of new vector s_t
        ...
        if FILTER:
            ...
            df_filtered_st.transpose().to_csv(f"t={t}_Gene_expression_filtered.csv")
